package com.example.hmsdemo.ml.object;
/*
...
import com.example.hmsdemo.ml.camera.GraphicOverlay;
...
public class MLObjectGraphic extends GraphicOverlay.Graphic {
    ...
    private final int pink = Color.parseColor("#ff1fbf");
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.object.getTypePossibility() != null) {
            canvas.drawText("confidence: " + String.format("%.2f",this.object.getTypePossibility()), rect.right, rect.bottom, this.textPaint);
        }
    }
