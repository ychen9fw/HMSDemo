package com.example.hmsdemo.ml.text;
/*
...
public class ImageTextAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "ImageTextAnalyse";
    ...
    private void localAnalyzer() {
        ...
        MLLocalTextSetting setting =
            new MLLocalTextSetting.Factory().setOCRMode(MLLocalTextSetting.OCR_DETECT_MODE).setLanguage("en").create();
        this.analyzer = MLAnalyzerFactory.getInstance().getLocalTextAnalyzer(setting);
     ...
     * alliance(https://developer.huawei.com/consumer/en/doc/development/HMS-Guides/ml-preparations4),
    ...
    private void remoteAnalyzer() {
        ...
        MLRemoteTextSetting setting =
            new MLRemoteTextSetting.Factory().setTextDensityScene(MLRemoteTextSetting.OCR_COMPACT_SCENE).create();
...
//        this.mTextView.setText(language+": "+result);
