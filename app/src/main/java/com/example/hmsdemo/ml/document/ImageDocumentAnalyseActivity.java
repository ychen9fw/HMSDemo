package com.example.hmsdemo.ml.document;
/*
...
public class ImageDocumentAnalyseActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "ImageDocumentAnalyse";
    ...
    private void analyzer() {
        ...
        this.mTextView.setText("Analyzing...");
        ...
        MLDocumentSetting setting = (new MLDocumentSetting.Factory()).create();
    ...
    private void displayFailure(Exception e) {
        Log.d(TAG, "Analyze >> Failure >> " + e.toString());
...
//            language += (block.getLanguageList()).get(0).getLanguage()+" ";
            ...
            for (MLDocument.Section section : sections) {
                ...
                for (MLDocument.Line line : lines) {
                    ...
                    for(TextLanguage languages: line.getLanguageList()){
                        System.out.println("Language: " + languages.getLanguage());
                    }
