...
public class HarmfulAppsDataListAdapter extends BaseAdapter {
    ...
    public HarmfulAppsDataListAdapter(List<MaliciousAppsData> data, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MaliciousAppsData oneHarmfulAppsData = this.harmfulAppsData.get(position);
        txtAppPackageName.setText(oneHarmfulAppsData.getApkPackageName());
        txtAppCategory.setText(getCategory(oneHarmfulAppsData.getApkCategory()));
        return convertView;
    }
